...
# # Test cơ bản - gửi 1 message và chờ response
# python can_example.py -c 0 -b 500000

# # Chỉ gửi message với ID và data tùy chỉnh
# python can_example.py -c 0 -b 500000 --send 0x123 0x11 0x22 0x33 0x44

# # Lắng nghe tất cả CAN messages (Ctrl+C để dừng)
# python can_example.py -c 0 -b 500000 --listen

# # Loopback test - gửi rồi chờ nhận
# python can_example.py -c 0 -b 500000 --loopback